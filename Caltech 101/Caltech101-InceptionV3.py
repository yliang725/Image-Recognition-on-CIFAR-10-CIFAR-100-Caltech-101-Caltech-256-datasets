...
path_train = '101_ObjectCategories/101_ObjectCategories_train'
path_test = '101_ObjectCategories/101_ObjectCategories_test'
...
print('start11')
callbacks = [ModelCheckpoint('Caltech101.h5', monitor='val_accuracy', save_best_only=True)]
